...
abstract class $NoteCopyWith<$Res> {
  ...
  $Res call({UniqueId id, NoteBody body, Color color, List<TodoItem> todos});
}
...
class _$_Note extends _Note {
  ...
  int get hashCode => Object.hash(
      runtimeType, id, body, color, const DeepCollectionEquality().hash(todos));
...
abstract class _Note extends Note {
  const factory _Note(
      ...
      required NoteBody body,
      required Color color,
      required List<TodoItem> todos}) = _$_Note;
